...
import {
  writeFileSync, readFileSync, existsSync, statSync, mkdirSync, cpSync, copyFileSync, unlinkSync,
} from "node:fs";
...
async function main() {
  ...
  const staleModern = resolve(DIST_DIR, "modern.min.js");
  if (existsSync(staleModern)) unlinkSync(staleModern);
